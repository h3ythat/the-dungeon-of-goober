...
scene.onOverlapTile(SpriteKind.Player, assets.tile`bigShinyRedButton1`, function (sprite, location) {
    tiles.setTileAt(tiles.getTileLocation(10, 9), assets.tile`bigShinyRedButton2`)
    buttonpressed = 0
    timer.after(500, function () {
        tiles.setTileAt(tiles.getTileLocation(10, 9), assets.tile`bigShinyRedButton1`)
        buttonpressed = 1
    })
})
...
class ActionKind {
    ...
    static walkingright: number
    private ___walkingright_is_set: boolean
    private ___walkingright: number
    get walkingright(): number {
        return this.___walkingright_is_set ? this.___walkingright : ActionKind.walkingright
    }
    set walkingright(value: number) {
        this.___walkingright_is_set = true
        this.___walkingright = value
    }
...
game.onUpdate(function () {
    ...
    if (buttonpressed == 1) {
        numberthingy = numberthingy + 1
        numberthingy = numberthingy + 1
        Enemyname = "Enemy" + ("" + numberthingy)
    }
})
